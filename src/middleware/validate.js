...
import { addListenValidation, updateListenValidation } from "../modules/listen/listen.validation.js";
...
export const validate = (schema) => {
    ...
    return (req, res, next) => {
        ...
        if (schema == addListenValidation || schema == updateListenValidation) {
            filter = { images: req.files, ...req.body, ...req.params, ...req.query }
